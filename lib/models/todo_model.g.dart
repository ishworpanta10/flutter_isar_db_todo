...
extension TodoModelQueryFilter
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterFilterCondition> doneIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'done',
      ));
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterFilterCondition> doneIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'done',
      ));
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterFilterCondition> doneEqualTo(
      bool? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'done',
...
extension TodoModelQuerySortBy on QueryBuilder<TodoModel, TodoModel, QSortBy> {
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterSortBy> sortByDone() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'done', Sort.asc);
    });
  }

  QueryBuilder<TodoModel, TodoModel, QAfterSortBy> sortByDoneDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoModelQuerySortThenBy
  ...
  QueryBuilder<TodoModel, TodoModel, QAfterSortBy> thenByDone() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'done', Sort.asc);
    });
  }

  QueryBuilder<TodoModel, TodoModel, QAfterSortBy> thenByDoneDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'done', Sort.desc);
    });
  }
...
extension TodoModelQueryWhereDistinct
  ...
  QueryBuilder<TodoModel, TodoModel, QDistinct> distinctByDone() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoModelQueryProperty
  ...
  QueryBuilder<TodoModel, bool?, QQueryOperations> doneProperty() {
    return QueryBuilder.apply(this, (query) {
